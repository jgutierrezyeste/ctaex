    ...
    <tbody>
        ...
        <tr>
            <td style="border:1px solid; border-top:0px;  padding:12px; background-color: rgb(224, 204, 204)"  >   
                ...
                <!--<input class="inputtable" id="fecha_nacimiento" type="date" style="color:blue" value="{{ $expediente->datos_personales->fecha_nacimiento ?$expediente->datos_personales->fecha_nacimiento:'Sin datos' }}"></input>-->
                <input class="inputtable" id="fecha_nacimiento"  style="color:blue" value="{{ $expediente->datos_personales->fecha_nacimiento ?date("d/m/Y",strtotime ($expediente->datos_personales->fecha_nacimiento)):'Sin datos' }}"></input>
