...
<table class="tableficha" cellspacing="0" cellpadding="8"  >
    ...
    <tbody style="align:right ;background-color:white">
        <tr>
            <td  style="padding:2px"   colspan="2" align="left">                
                    <b style="color:orange; face:Arial,Helvetica">FICHA </b>
        ...
        <tr>
            <td style=" padding:4px; padding-left:20px " colspan="2">
                    ...
                    <b >Número: <b style ="color:red">{{ $expediente->num_expte_intranet }} - {{ $expediente->datos_personales->apellido1 }} {{ $expediente->datos_personales->apellido2 }}, {{ $expediente->datos_personales->nombre }}   ({{ $expediente->datos_personales->sexos->nombre }})</b></b>
